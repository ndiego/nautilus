...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-columns alignwide" style="padding-top:4.5rem;padding-bottom:3rem">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="margin-bottom:1.5rem">
				<!-- wp:site-logo {"width":60,"className":"is-style-rounded","style":{"color":{"duotone":["#0F172A","#F9FAFB"]}}} /-->
				<!-- wp:site-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}}} /-->
			</div>
			<!-- /wp:group -->
		</div>
		<!-- /wp:column -->
	...
	<div class="wp-block-group alignwide" style="padding-bottom:3rem">
		<!-- wp:paragraph {"textColor":"tertiary","className":"has-primary-font-family","fontSize":"small"} -->
